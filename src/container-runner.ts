...
const AGENT_STATE_DIRNAME = '.codex';
...
function buildVolumeMounts(
  ...
  // Per-group Codex state directory (isolated from other groups)
  // Each group gets their own state directory to prevent cross-group access.
